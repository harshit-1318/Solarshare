...
export default function ProsumerCertTable({ certs, handleTradeCertificate }) {
  return (
    <section className="mt-6">
      <div className="mb-3 flex items-center gap-3">
        ...
        <div>
          ...
          <h2 className="mt-0.5 font-heading text-lg font-semibold text-slate-900">Issued Certificates</h2>
        </div>
      </div>
        ...
        <table className="min-w-[760px] w-full text-left text-sm">
          <thead className="table-header">
            <tr>
              ...
              <th className="px-5 py-3.5">Solar Energy Sold</th>
              <th className="px-5 py-3.5">CO2 Prevented</th>
            ...
            {certs.map((c) => (
              <tr className="hover:bg-slate-50/70" key={c._id}>
                ...
                <td className="px-5 py-4 flex gap-3">
                  ...
                  <button
                    onClick={() => handleTradeCertificate(c._id)}
                    className="flex items-center gap-0.5 text-xs font-bold text-amber-600 hover:text-amber-700"
                  >
                    <ShoppingBag size={12} /> Sell/Trade
                  </button>
                </td>
              </tr>
            ))}
              ...
              <tr>
                <td colSpan="6" className="px-6 py-14 text-center">
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Use the "Mint Certificate" button above to convert your solar volume to carbon offsets.
                  </p>
                </td>
              </tr>
            )}
